...
experiment = "detail_lambda" # "main" for ye + niba experiements, "sozh" for experiments from AVT.FVT lab.
...
if __name__ == "__main__":
    ...
    df_results.to_csv('simulation_results_parallel_evaluation_detail_lambda.csv', index=False)
