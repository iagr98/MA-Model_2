...
r_v = [0.05186,0.05186,0.03328,0.03328,0.02242,0.02242,0.02072,0.02072, 0.05186,0.05186,0.03328,0.03328,0.02242,0.02242,0.02072,0.02072] # sedimentation
r_v_error = [0.003415353, 0.003415353, 0.00081852, 0.00081852, 0.000984693, 0.000984693, 0.000386075, 0.000386075,  0.003415353, 0.003415353, 0.00081852, 0.00081852, 0.000984693, 0.000984693, 0.000386075, 0.000386075] # sedimentation error
...
# r_v_error = [0.0138768,0.0138768,0.000560916,0.000560916,0.001290627,0.001290627,0.000829708,0.000829708, 0.0138768,0.0138768,0.000560916,0.000560916,0.001290627,0.001290627,0.000829708,0.000829708]
# r_v = np.array(r_v) - np.array(r_v_error)
# r_v = 1.378900765*np.array(r_v) # scale r_v to 'fit' flooding points
...
for i in range(len(d32)):
    ...
    name = str(i) + '_Floodpoint_' + str(T[i]) + 'C' + '_' + str(phase_frac[i]) + 'phasefrac' + '_' + str(d32[i]) + 'um' + str(r_v[i])
...
df.to_csv('2025_04_15_input_T-dependentflooding_sedimentation_d32_120.csv')
